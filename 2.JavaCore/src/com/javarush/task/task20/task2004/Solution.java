...
public class Solution {
    ...
    public static class ClassWithStatic {
        ...
        public void save(OutputStream outputStream) throws Exception {
            ...
            printWriter.write(i + "," + j + "," + staticString);
            printWriter.flush();
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            ClassWithStatic classWithStatic = this;
            classWithStatic.i = Integer.parseInt(strings[0]);
            classWithStatic.j = Integer.parseInt(strings[1]);
            staticString = strings[2];
